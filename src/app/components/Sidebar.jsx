...
const Sidebar = () => {
  return (
    <div className="flex flex-col items-start gap-6">
      ...
      <button className="py-2 px-6 bg-blue-500 text-white font-bold rounded-full hover:bg-blue-600 transition-all duration-300 brightness-90 active:brightness-100 active:scale-95 shadow-md hidden xl:block">
